from model_hLSTMat_mgpu.solver import Solver
from model_hLSTMat_mgpu.model import Model
...
def main():
    ...
    solver = Solver(model, data, n_epochs=100, batch_size=64 * 4, update_rule='adam',
